...
აქ ჩანს რომელ feature-ებს აქვთ ყველაზე მეტი missing data. უფრო ვრცლად Feature engineering-ის სექციაში ავხსნი.
...
ეს feature-ები შევქმენით სუფთა დატაზე:
...
რატომ lag features? ამ კვირის გაყიდვები, როგორც წესი წინა რამდენიმე კვირის გაყიდვებთან ახლოს არის, განსაკუთრებით იგივე store და department-ისთვის. მოდელისთვის ამ ინფორმაციის მიცემით, გავუადვილეთ პრგნოზი.
...
იგივე ვალიდაციის window როგორც ყველა სხვა მოდელში. მოკლედ: უბრალოდ ტრენინგის ბოლო 39 კვირა შეიცავს მხოლოდ სუპერ ბოულს და ლეიბორ დეის და არ შეიცავს Thanksgiving-ს და Christmas-ს. გადმოვიწეთ window უკან 52 კვირით, რომ დაემთხვეს ნამდვილ ტესტის პერიოდის ჰოლიდეიებს: Nov 2011 -
Jul 2012.
